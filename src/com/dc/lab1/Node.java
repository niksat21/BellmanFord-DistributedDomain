...
public class Node {
    ...
    BlockingQueue<Message> killTheThread;
    String pred;
    ...
    public Node(String nodeID, List<String> nbrs, Integer numberOfNbrs, List<Integer> edgesToNbrs) {
        ...
        this.killTheThread = new ArrayBlockingQueue<Message>(1);
    }
    ...
    public synchronized BlockingQueue<Message> getKillTheThread(){
    	return killTheThread;
    }
}
